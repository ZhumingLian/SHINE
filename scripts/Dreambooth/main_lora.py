...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default="outputs_dreameditbench/test_lora")
...
def main(args):
    # 1. init fill model and editing model
    ...
    for class_name in os.listdir(args.dataset_dir):
        ...
        edit_pipe.load_lora_weights(lora_file_path)
        ...
        # 3. preprocess
        output_dir = f"{args.output_dir}/{class_name}"
        ...
        if not os.path.exists(content_file):
            print(f"content.json nor found: {content_file}")
            continue
        with open(content_file, 'r') as f:
            ...
            for item in data:
                ...
                # create user mask accroding to the bbox
